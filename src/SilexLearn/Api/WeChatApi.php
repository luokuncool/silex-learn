        ...
        if ($content == '设置菜单') {
            $setMenu = array(
                ...
                array(
                    'type'       => 'view',
                    'name'       => '点我',
                    'url'        => 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx0243cccf60129301&redirect_uri=http%3A%2F%2Fsilex-learn.luokuncool.com%2Fauth_callback&response_type=code&scope=snsapi_base&state=getUserInfo#wechat_redirect',
                    'key'        => 'my_click1',
                    'sub_button' =>
                        array(),
                )
